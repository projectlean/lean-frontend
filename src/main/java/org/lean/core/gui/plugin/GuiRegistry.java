...
public class GuiRegistry {
     ...
     */
    public void registerGuiPluginObject( String leanLayoutGuiId, String guiPluginClassname, String instanceId, Object guiPluginObject ) {
        Map<String, Map<String, Object>> instanceObjectsMap = guiPluginObjectsMap.get(leanLayoutGuiId );
        if ( instanceObjectsMap == null ) {
            instanceObjectsMap = new HashMap<>();
            guiPluginObjectsMap.put( leanLayoutGuiId, instanceObjectsMap );
        }
